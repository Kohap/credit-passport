...
| Artifact | Value |
| --- | --- |
| Sepolia `LoanRepaid` tx | Run a new v2 demo before submission. |
| Creditcoin `proveRepayment` tx | Run a new v2 demo before submission. |
| Passport tokenId | Generated by the v2 proof transaction. |
