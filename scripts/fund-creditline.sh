...
CREDITCOIN_MOCK_USD="${CREDITCOIN_MOCK_USD:-0x3937cFf0385AF9aAA25212432f030Ddbb1B98798}"
CREDITCOIN_CREDIT_LINE="${CREDITCOIN_CREDIT_LINE:-0xd23Ba880D8C459A6A489017A021301053b3bC6fb}"
AMOUNT_WHOLE="${1:-1000000}"
if ! [[ "$AMOUNT_WHOLE" =~ ^[1-9][0-9]{0,12}$ ]]; then
  echo "Amount must be a whole number between 1 and 9999999999999 mUSD." >&2
  exit 1
fi
# 1e18 * amount
